...
import com.salesforce.pages.servicecloud.accounts.ServiceCloudAccountsEdit;
import com.salesforce.tests.functionaltests.CloudBaseTest;


@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class UpdateTypeOnAccountEdit extends CloudBaseTest 
{
	@Test
	public void testUpdateTypeOnAccountEdit() throws BiffException, IOException,
			InterruptedException, RowsExceededException, WriteException 
	{
		...
		ServiceCloudAccountsEdit edit = detail.clickOnEdit();
		
		edit.verifyPageLoad().selectAccountsType(type).clickOnSaveButton();
