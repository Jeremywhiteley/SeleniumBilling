...
public class UpdateCasePriorityOnDetail extends CloudBaseTest 
{
	@Test
	public void testUpdateCasePriorityOnDetail() throws BiffException, IOException,
			InterruptedException, RowsExceededException, WriteException 
	{
		 ...
		 * Assertion
		 */
		assertThat(detail.getCaseHeader().toUpperCase(), containsString(caseName.toUpperCase()));
		assertEquals(priority.toUpperCase(), detail.selectFromLeftNav(leftNavigationTab).updateCasePriority(priority).verifyPageLoad().getCasePriority().toUpperCase());
