...
public class createorderforonetimeandmonthly extends CloudBaseTest{
	
	@Test
	public void test_CreateOrderForOnetimeAndMonthlyCharges() throws BiffException, IOException, InterruptedException,
	RowsExceededException, WriteException, ParseException {
		...
		.clickOnNextButton().addProducts(addproduct).clickOnAddButton2().clickOnNextStep2Button().clickOnSaveButton();
