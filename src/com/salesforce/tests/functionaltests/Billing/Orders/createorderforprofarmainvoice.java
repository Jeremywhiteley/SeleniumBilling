...
public class createorderforprofarmainvoice extends CloudBaseTest{

	
	@Test
	public void test_CreateOrderForInvoice() throws BiffException, IOException, InterruptedException,
	RowsExceededException, WriteException, ParseException {
		...
		//verifying the subtotal is calculated exactly or not
