...
public class SelectContactAddOpp_Sales extends CloudBaseTest
{
	
	@Test
	public void testSelectContactAddOpp_Sales() throws BiffException, IOException, InterruptedException,
			RowsExceededException, WriteException
	{
		...
		OpportunitiesSelectRecordType opportunityType = detail.verifyPageLoad().clickOnNewOpportunityButton();
		...
		detail = searchResults.verifyPageLoad().searchContactResultsForRecord(
				contactName);
