...
public class SelectContactLogACall_Sales extends CloudBaseTest
{

	@Test
	public void testSelectContactAddLogACallTask_Sales() throws BiffException, IOException,
			InterruptedException, RowsExceededException, WriteException
	{
		...
		taskEdit.setSubject(taskSubject).clickOnSave();

		
		/**
		 * Assertion
		 */
		assertTrue("Log a Call Task was found in the Activities related list", detail.verifyPageLoad()
