...
public class SearchSelectAccount_Sales extends CloudBaseTest
{
			...
			InterruptedException, RowsExceededException, WriteException
	{
		 ...
		 * Assertion
		 */
		assertThat("Account name shown incorrectly", detail.getHeaderText().toUpperCase(),
				containsString(accountName.toUpperCase()));
