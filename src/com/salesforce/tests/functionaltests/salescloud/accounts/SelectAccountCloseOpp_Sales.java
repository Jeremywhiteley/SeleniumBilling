...
public class SelectAccountCloseOpp_Sales extends CloudBaseTest
{

	@Test
	public void testSelectAccountCloseOpp_Sales() throws BiffException, IOException, InterruptedException,
			RowsExceededException, WriteException
	{
		...
		accountDetail.deleteOpportunity(opportunityName);
		
		
		/**
		 * Assertion
		 */
		assertFalse("Opportunity not found in the Opportunities related list", accountDetail.verifyPageLoad().getPresenceOfOpportunity(opportunityName));
	}
