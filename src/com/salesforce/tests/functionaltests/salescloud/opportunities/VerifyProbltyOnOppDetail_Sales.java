...
public class VerifyProbltyOnOppDetail_Sales extends CloudBaseTest
{

	@Test
	public void testUpdateOnProbabilityInOpportunityDetail_Sales() throws BiffException,
			IOException, InterruptedException, RowsExceededException, WriteException
	{
		...
		final String probability = xlsUtil.ReadCell(xlsUtil.GetCell("Probability"), 1);
		 ...
		 * Assertion
		 */
		assertThat("Probability value incorrect after updating stage in Opportunity", detail
				.verifyPageLoad().getProbability(), containsString(probability));
	}
