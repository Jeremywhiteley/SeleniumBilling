...
public class ServiceCloudChangeActivityOwner extends PageBase
{

	private static ServiceCloudChangeActivityOwner instance;
	public static ServiceCloudChangeActivityOwner Instance = (instance != null) ? instance
			: new ServiceCloudChangeActivityOwner();
	...
	public ServiceCloudChangeActivityOwner changeOwner(String owner) throws InterruptedException
	{
	...
	public ServiceCloudChangeActivityOwner enterOwnerNameDirectly(String owner)
	{
	...
	public ServiceCloudChangeActivityOwner selectOwnerQueue(String ownerQueue)
	{
	...
	public ServiceCloudChangeActivityOwner verifyPageLoad()
	{
