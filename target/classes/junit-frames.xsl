...
<xsl:template match="testsuite" mode="class.details">
    ...
    <html>
        <head>
          <title>Test Results: <xsl:value-of select="$class.name"/></title>
            <xsl:call-template name="create.stylesheet.link">
...
<xsl:template name="pageHeader">
    ...
    <h4><a href="file://localhost/Users/jdapper/Dev/Git/WebDriver/JunitTest/archive/" target="_blank">View Archive</a></h4>
    <table width="100%">
    <tr>
        <td align="left"></td>
        <td align="right">Salesforce WebDriver Framework 2014</td>
    </tr>
    </table>
    <hr size="1"/>
</xsl:template>
